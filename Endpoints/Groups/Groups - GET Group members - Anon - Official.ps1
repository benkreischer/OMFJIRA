...
$Headers = Get-RequestHeaders -Parameters $Params
    ...
    # PARAMETER - REQUIRED
    # =============================================================================
    $GroupName = "administrators" # <-- IMPORTANT: Replace with valid GroupName
# API CALL
# =============================================================================
$Endpoint = "/rest/api/3/group/member?groupname=administrators"
...
try {
    ...
    # EXPORT TO CSV
    # =============================================================================
    $OutputFile = "Groups - GET Group members - Anon - Official.csv"
