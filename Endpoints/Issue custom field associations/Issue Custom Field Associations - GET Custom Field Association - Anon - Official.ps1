# =============================================================================
# ENDPOINT: Issue Custom Field Associations - GET Custom Field Association
# =============================================================================
#
# API DOCUMENTATION: https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issue-custom-field-associations/#api-rest-api-3-issue-issueidorkey-customfield-associations-id-get
#
# DESCRIPTION: Returns an association for a custom field.
#
# SETUP:
...
try {
    ...
    # EXPORT TO CSV
    # =============================================================================
    $OutputFile = "Issue Custom Field Associations - GET Custom Field Association - Anon - Official.csv"
