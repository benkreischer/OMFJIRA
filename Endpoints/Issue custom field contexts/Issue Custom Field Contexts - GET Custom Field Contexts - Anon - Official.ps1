# =============================================================================
# ENDPOINT: Issue Custom Field Contexts - GET Custom Field Contexts
# =============================================================================
#
# API DOCUMENTATION: https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issue-custom-field-contexts/
#
# DESCRIPTION: Returns a paginated list of contexts for a custom field. Contexts can be used to restrict the scope of custom fields.
#
# SETUP:
...
# API CALL
# =============================================================================
$Endpoint = "/rest/api/3/field/customfield_10001/context"
...
try {
    ...
    # EXPORT TO CSV
    # =============================================================================
    $OutputFile = "Issue Custom Field Contexts - GET Custom Field Contexts - Anon - Official.csv"
