# =============================================================================
# ENDPOINT: Issue Custom Field Options - GET Custom Field Option
# =============================================================================
#
# API DOCUMENTATION: https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issue-custom-field-options/
#
# DESCRIPTION: Returns a custom field option. For example, an option in a cascading select list custom field.
#
# SETUP:
...
# API CALL
# =============================================================================
$Endpoint = "/rest/api/3/customFieldOption/10001"
...
try {
    ...
    # EXPORT TO CSV
    # =============================================================================
    $OutputFile = "Issue Custom Field Options - GET Custom Field Option - Anon - Official.csv"
