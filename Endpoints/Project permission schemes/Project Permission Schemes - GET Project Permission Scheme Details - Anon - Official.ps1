# =============================================================================
# ENDPOINT: Project Permission Schemes - GET Project Permission Scheme Details
# =============================================================================
#
# API DOCUMENTATION: https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-project-permission-schemes/#api-rest-api-3-project-projectidorkey-permissionscheme-details-get
#
# DESCRIPTION: Returns the permission scheme details for the project.
#
# SETUP:
...
try {
    ...
    # EXPORT TO CSV
    # =============================================================================
    $OutputFile = "Project Permission Schemes - GET Project Permission Scheme Details - Anon - Official.csv"
