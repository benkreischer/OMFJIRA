# =============================================================================
# ENDPOINT: Workflow Transition Properties - GET Workflow Transition Properties
# =============================================================================
#
# API DOCUMENTATION: https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-workflow-transition-properties/
#
...
# API CALL
# =============================================================================
$Endpoint = "/rest/api/3/workflow/transitionproperties"
$FullUrl = $BaseUrl + $Endpoint + "?workflowName=jira&transitionId=1"
...
try {
    ...
    # EXPORT TO CSV
    # =============================================================================
    $OutputFile = "Workflow Transition Properties - GET Workflow Transition Properties - Anon - Official.csv"
