...
$steps = @(
    ...
    @{Number="09"; Name="Attachments"; Description="Migrate attachments (IDEMPOTENT)"; Critical=$true},
    @{Number="10"; Name="Comments"; Description="Migrate comments (IDEMPOTENT)"; Critical=$true},
