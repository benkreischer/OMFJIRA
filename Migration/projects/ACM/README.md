# ACM Migration Project

**Created:** 2025-10-14  
**Source Project:** ACM  
**Target Project:** ACM1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey ACM`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: ACM)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: ACM1)
...
```powershell
.\RunMigration.ps1 -Project ACM -Step 01
.\RunMigration.ps1 -Project ACM -Step 02
.\RunMigration.ps1 -Project ACM -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project ACM -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project ACM`
