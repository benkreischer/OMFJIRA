# ACQ Migration Project

**Created:** 2025-10-14  
**Source Project:** ACQ  
**Target Project:** ACQ1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey ACQ`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: ACQ)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: ACQ1)
...
```powershell
.\RunMigration.ps1 -Project ACQ -Step 01
.\RunMigration.ps1 -Project ACQ -Step 02
.\RunMigration.ps1 -Project ACQ -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project ACQ -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project ACQ`
