# ACQE Migration Project

**Created:** 2025-10-14  
**Source Project:** ACQE  
**Target Project:** ACQE1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey ACQE`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: ACQE)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: ACQE1)
...
```powershell
.\RunMigration.ps1 -Project ACQE -Step 01
.\RunMigration.ps1 -Project ACQE -Step 02
.\RunMigration.ps1 -Project ACQE -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project ACQE -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project ACQE`
