...
**Created:** 2025-10-14  
**Source Project:** AI  
**Target Project:** AI1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey AI`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: AI)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: AI1)
...
```powershell
.\RunMigration.ps1 -Project AI -Step 01
.\RunMigration.ps1 -Project AI -Step 02
.\RunMigration.ps1 -Project AI -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project AI -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project AI`
