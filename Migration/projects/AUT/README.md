# AUT Migration Project

**Created:** 2025-10-14  
**Source Project:** AUT  
**Target Project:** AUT1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey AUT`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: AUT)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: AUT1)
...
```powershell
.\RunMigration.ps1 -Project AUT -Step 01
.\RunMigration.ps1 -Project AUT -Step 02
.\RunMigration.ps1 -Project AUT -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project AUT -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project AUT`
