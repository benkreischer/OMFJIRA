# BAS Migration Project

**Created:** 2025-10-14  
**Source Project:** BAS  
**Target Project:** BAS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey BAS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: BAS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: BAS1)
...
```powershell
.\RunMigration.ps1 -Project BAS -Step 01
.\RunMigration.ps1 -Project BAS -Step 02
.\RunMigration.ps1 -Project BAS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project BAS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project BAS`
