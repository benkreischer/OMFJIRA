# BDME Migration Project

**Created:** 2025-10-14  
**Source Project:** BDME  
**Target Project:** BDME1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey BDME`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: BDME)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: BDME1)
...
```powershell
.\RunMigration.ps1 -Project BDME -Step 01
.\RunMigration.ps1 -Project BDME -Step 02
.\RunMigration.ps1 -Project BDME -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project BDME -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project BDME`
