# BINT Migration Project

**Created:** 2025-10-14  
**Source Project:** BINT  
**Target Project:** BINT1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey BINT`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: BINT)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: BINT1)
...
```powershell
.\RunMigration.ps1 -Project BINT -Step 01
.\RunMigration.ps1 -Project BINT -Step 02
.\RunMigration.ps1 -Project BINT -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project BINT -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project BINT`
