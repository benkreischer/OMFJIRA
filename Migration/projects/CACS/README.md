# CACS Migration Project

**Created:** 2025-10-14  
**Source Project:** CACS  
**Target Project:** CACS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CACS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CACS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CACS1)
...
```powershell
.\RunMigration.ps1 -Project CACS -Step 01
.\RunMigration.ps1 -Project CACS -Step 02
.\RunMigration.ps1 -Project CACS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CACS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CACS`
