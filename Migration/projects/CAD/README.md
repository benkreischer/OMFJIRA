# CAD Migration Project

**Created:** 2025-10-16  
**Source Project:** CAD  
**Target Project:** CAD1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CAD`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CAD)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CAD1)
...
```powershell
.\RunMigration.ps1 -Project CAD -Step 01
.\RunMigration.ps1 -Project CAD -Step 02
.\RunMigration.ps1 -Project CAD -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CAD -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CAD`
