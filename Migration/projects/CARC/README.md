# CARC Migration Project

**Created:** 2025-10-14  
**Source Project:** CARC  
**Target Project:** CARC1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CARC`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CARC)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CARC1)
...
```powershell
.\RunMigration.ps1 -Project CARC -Step 01
.\RunMigration.ps1 -Project CARC -Step 02
.\RunMigration.ps1 -Project CARC -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CARC -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CARC`
