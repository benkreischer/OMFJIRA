...
**Created:** 2025-10-14  
**Source Project:** CARD  
**Target Project:** CARD1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CARD`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CARD)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CARD1)
...
```powershell
.\RunMigration.ps1 -Project CARD -Step 01
.\RunMigration.ps1 -Project CARD -Step 02
.\RunMigration.ps1 -Project CARD -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CARD -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CARD`
