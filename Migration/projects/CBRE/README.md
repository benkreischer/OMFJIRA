# CBRE Migration Project

**Created:** 2025-10-16  
**Source Project:** CBRE  
**Target Project:** CBRE1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CBRE`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CBRE)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CBRE1)
...
```powershell
.\RunMigration.ps1 -Project CBRE -Step 01
.\RunMigration.ps1 -Project CBRE -Step 02
.\RunMigration.ps1 -Project CBRE -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CBRE -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CBRE`
