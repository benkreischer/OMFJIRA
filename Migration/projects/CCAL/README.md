# CCAL Migration Project

**Created:** 2025-10-14  
**Source Project:** CCAL  
**Target Project:** CCAL1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CCAL`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CCAL)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CCAL1)
...
```powershell
.\RunMigration.ps1 -Project CCAL -Step 01
.\RunMigration.ps1 -Project CCAL -Step 02
.\RunMigration.ps1 -Project CCAL -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CCAL -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CCAL`
