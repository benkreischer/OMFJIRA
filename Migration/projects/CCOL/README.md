# CCOL Migration Project

**Created:** 2025-10-14  
**Source Project:** CCOL  
**Target Project:** CCOL1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CCOL`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CCOL)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CCOL1)
...
```powershell
.\RunMigration.ps1 -Project CCOL -Step 01
.\RunMigration.ps1 -Project CCOL -Step 02
.\RunMigration.ps1 -Project CCOL -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CCOL -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CCOL`
