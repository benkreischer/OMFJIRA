# CCP Migration Project

**Created:** 2025-10-14  
**Source Project:** CCP  
**Target Project:** CCP1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CCP`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CCP)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CCP1)
...
```powershell
.\RunMigration.ps1 -Project CCP -Step 01
.\RunMigration.ps1 -Project CCP -Step 02
.\RunMigration.ps1 -Project CCP -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CCP -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CCP`
