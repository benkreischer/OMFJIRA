# CCT Migration Project

**Created:** 2025-10-15  
**Source Project:** CCT  
**Target Project:** CCT1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CCT`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CCT)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CCT1)
...
```powershell
.\RunMigration.ps1 -Project CCT -Step 01
.\RunMigration.ps1 -Project CCT -Step 02
.\RunMigration.ps1 -Project CCT -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CCT -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CCT`
