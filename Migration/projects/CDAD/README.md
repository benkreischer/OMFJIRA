# CDAD Migration Project

**Created:** 2025-10-14  
**Source Project:** CDAD  
**Target Project:** CDAD1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CDAD`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CDAD)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CDAD1)
...
```powershell
.\RunMigration.ps1 -Project CDAD -Step 01
.\RunMigration.ps1 -Project CDAD -Step 02
.\RunMigration.ps1 -Project CDAD -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CDAD -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CDAD`
