# CDL Migration Project

**Created:** 2025-10-14  
**Source Project:** CDL  
**Target Project:** CDL1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CDL`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CDL)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CDL1)
...
```powershell
.\RunMigration.ps1 -Project CDL -Step 01
.\RunMigration.ps1 -Project CDL -Step 02
.\RunMigration.ps1 -Project CDL -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CDL -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CDL`
