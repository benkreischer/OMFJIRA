# CE Migration Project

**Created:** 2025-10-14  
**Source Project:** CE  
**Target Project:** CE1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CE`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CE)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CE1)
...
```powershell
.\RunMigration.ps1 -Project CE -Step 01
.\RunMigration.ps1 -Project CE -Step 02
.\RunMigration.ps1 -Project CE -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CE -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CE`
