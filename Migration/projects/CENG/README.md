# CENG Migration Project

**Created:** 2025-10-15  
**Source Project:** CENG  
**Target Project:** CENG1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CENG`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CENG)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CENG1)
...
```powershell
.\RunMigration.ps1 -Project CENG -Step 01
.\RunMigration.ps1 -Project CENG -Step 02
.\RunMigration.ps1 -Project CENG -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CENG -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CENG`
