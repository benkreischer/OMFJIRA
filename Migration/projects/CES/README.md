# CES Migration Project

**Created:** 2025-10-14  
**Source Project:** CES  
**Target Project:** CES1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CES`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CES)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CES1)
...
```powershell
.\RunMigration.ps1 -Project CES -Step 01
.\RunMigration.ps1 -Project CES -Step 02
.\RunMigration.ps1 -Project CES -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CES -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CES`
