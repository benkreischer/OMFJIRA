# CISRE Migration Project

**Created:** 2025-10-14  
**Source Project:** CISRE  
**Target Project:** CISRE1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CISRE`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CISRE)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CISRE1)
...
.\RunMigration.ps1 -Project CISRE
```
...
```powershell
.\RunMigration.ps1 -Project CISRE -Step 01
.\RunMigration.ps1 -Project CISRE -Step 02
.\RunMigration.ps1 -Project CISRE -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CISRE -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CISRE`
