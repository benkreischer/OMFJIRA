# CITM Migration Project

**Created:** 2025-10-14  
**Source Project:** CITM  
**Target Project:** CITM1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CITM`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CITM)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CITM1)
...
```powershell
.\RunMigration.ps1 -Project CITM -Step 01
.\RunMigration.ps1 -Project CITM -Step 02
.\RunMigration.ps1 -Project CITM -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CITM -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CITM`
