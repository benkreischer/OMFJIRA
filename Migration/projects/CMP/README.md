...
> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CMP`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CMP)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CMP1)
...
```powershell
.\RunMigration.ps1 -Project CMP -Step 01
.\RunMigration.ps1 -Project CMP -Step 02
.\RunMigration.ps1 -Project CMP -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CMP -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CMP`
