# CNE Migration Project

**Created:** 2025-10-14  
**Source Project:** CNE  
**Target Project:** CNE1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CNE`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CNE)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CNE1)
...
```powershell
.\RunMigration.ps1 -Project CNE -Step 01
.\RunMigration.ps1 -Project CNE -Step 02
.\RunMigration.ps1 -Project CNE -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CNE -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CNE`
