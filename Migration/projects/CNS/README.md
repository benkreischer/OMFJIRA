# CNS Migration Project

**Created:** 2025-10-14  
**Source Project:** CNS  
**Target Project:** CNS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CNS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CNS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CNS1)
...
```powershell
.\RunMigration.ps1 -Project CNS -Step 01
.\RunMigration.ps1 -Project CNS -Step 02
.\RunMigration.ps1 -Project CNS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CNS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CNS`
