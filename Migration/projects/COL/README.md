# COL Migration Project

**Created:** 2025-10-15  
**Source Project:** COL  
**Target Project:** COL1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey COL`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: COL)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: COL1)
...
```powershell
.\RunMigration.ps1 -Project COL -Step 01
.\RunMigration.ps1 -Project COL -Step 02
.\RunMigration.ps1 -Project COL -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project COL -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project COL`
