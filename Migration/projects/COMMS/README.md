# COMMS Migration Project

**Created:** 2025-10-14  
**Source Project:** COMMS  
**Target Project:** COMMS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey COMMS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: COMMS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: COMMS1)
...
.\RunMigration.ps1 -Project COMMS
```
...
```powershell
.\RunMigration.ps1 -Project COMMS -Step 01
.\RunMigration.ps1 -Project COMMS -Step 02
.\RunMigration.ps1 -Project COMMS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project COMMS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project COMMS`
