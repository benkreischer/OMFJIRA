# COMP Migration Project

**Created:** 2025-10-14  
**Source Project:** COMP  
**Target Project:** COMP1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey COMP`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: COMP)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: COMP1)
...
```powershell
.\RunMigration.ps1 -Project COMP -Step 01
.\RunMigration.ps1 -Project COMP -Step 02
.\RunMigration.ps1 -Project COMP -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project COMP -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project COMP`
