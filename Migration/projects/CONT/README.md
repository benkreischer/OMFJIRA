# CONT Migration Project

**Created:** 2025-10-16  
**Source Project:** CONT  
**Target Project:** CONT1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CONT`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CONT)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CONT1)
...
```powershell
.\RunMigration.ps1 -Project CONT -Step 01
.\RunMigration.ps1 -Project CONT -Step 02
.\RunMigration.ps1 -Project CONT -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CONT -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CONT`
