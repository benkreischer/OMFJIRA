# COPS Migration Project

**Created:** 2025-10-14  
**Source Project:** COPS  
**Target Project:** COPS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey COPS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: COPS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: COPS1)
...
```powershell
.\RunMigration.ps1 -Project COPS -Step 01
.\RunMigration.ps1 -Project COPS -Step 02
.\RunMigration.ps1 -Project COPS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project COPS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project COPS`
