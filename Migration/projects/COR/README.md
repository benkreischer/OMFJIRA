# COR Migration Project

**Created:** 2025-10-14  
**Source Project:** COR  
**Target Project:** COR1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey COR`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: COR)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: COR1)
...
```powershell
.\RunMigration.ps1 -Project COR -Step 01
.\RunMigration.ps1 -Project COR -Step 02
.\RunMigration.ps1 -Project COR -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project COR -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project COR`
