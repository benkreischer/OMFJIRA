# CRSK Migration Project

**Created:** 2025-10-14  
**Source Project:** CRSK  
**Target Project:** CRSK1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CRSK`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CRSK)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CRSK1)
...
```powershell
.\RunMigration.ps1 -Project CRSK -Step 01
.\RunMigration.ps1 -Project CRSK -Step 02
.\RunMigration.ps1 -Project CRSK -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CRSK -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CRSK`
