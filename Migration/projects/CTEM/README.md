# CTEM Migration Project

**Created:** 2025-10-14  
**Source Project:** CTEM  
**Target Project:** CTEM1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CTEM`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CTEM)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CTEM1)
...
```powershell
.\RunMigration.ps1 -Project CTEM -Step 01
.\RunMigration.ps1 -Project CTEM -Step 02
.\RunMigration.ps1 -Project CTEM -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CTEM -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CTEM`
