# CTGR Migration Project

**Created:** 2025-10-14  
**Source Project:** CTGR  
**Target Project:** CTGR1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CTGR`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CTGR)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CTGR1)
...
```powershell
.\RunMigration.ps1 -Project CTGR -Step 01
.\RunMigration.ps1 -Project CTGR -Step 02
.\RunMigration.ps1 -Project CTGR -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CTGR -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CTGR`
