# CUSD Migration Project

**Created:** 2025-10-14  
**Source Project:** CUSD  
**Target Project:** CUSD1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CUSD`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CUSD)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CUSD1)
...
```powershell
.\RunMigration.ps1 -Project CUSD -Step 01
.\RunMigration.ps1 -Project CUSD -Step 02
.\RunMigration.ps1 -Project CUSD -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CUSD -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CUSD`
