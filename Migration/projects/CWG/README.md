...
> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey CWG`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: CWG)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: CWG1)
...
```powershell
.\RunMigration.ps1 -Project CWG -Step 01
.\RunMigration.ps1 -Project CWG -Step 02
.\RunMigration.ps1 -Project CWG -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project CWG -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project CWG`
