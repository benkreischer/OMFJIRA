...
> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DARC`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DARC)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DARC1)
...
```powershell
.\RunMigration.ps1 -Project DARC -Step 01
.\RunMigration.ps1 -Project DARC -Step 02
.\RunMigration.ps1 -Project DARC -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DARC -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DARC`
