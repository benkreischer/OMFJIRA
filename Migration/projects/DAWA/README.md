# DAWA Migration Project

**Created:** 2025-10-14  
**Source Project:** DAWA  
**Target Project:** DAWA1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DAWA`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DAWA)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DAWA1)
...
```powershell
.\RunMigration.ps1 -Project DAWA -Step 01
.\RunMigration.ps1 -Project DAWA -Step 02
.\RunMigration.ps1 -Project DAWA -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DAWA -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DAWA`
