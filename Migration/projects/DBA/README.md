# DBA Migration Project

**Created:** 2025-10-14  
**Source Project:** DBA  
**Target Project:** DBA1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DBA`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DBA)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DBA1)
...
```powershell
.\RunMigration.ps1 -Project DBA -Step 01
.\RunMigration.ps1 -Project DBA -Step 02
.\RunMigration.ps1 -Project DBA -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DBA -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DBA`
