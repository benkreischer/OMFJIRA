# DBEAN Migration Project

**Created:** 2025-10-15  
**Source Project:** DBEAN  
**Target Project:** DBEAN1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DBEAN`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DBEAN)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DBEAN1)
...
.\RunMigration.ps1 -Project DBEAN
```
...
```powershell
.\RunMigration.ps1 -Project DBEAN -Step 01
.\RunMigration.ps1 -Project DBEAN -Step 02
.\RunMigration.ps1 -Project DBEAN -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DBEAN -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DBEAN`
