# DCI Migration Project

**Created:** 2025-10-16  
**Source Project:** DCI  
**Target Project:** DCI1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DCI`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DCI)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DCI1)
...
```powershell
.\RunMigration.ps1 -Project DCI -Step 01
.\RunMigration.ps1 -Project DCI -Step 02
.\RunMigration.ps1 -Project DCI -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DCI -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DCI`
