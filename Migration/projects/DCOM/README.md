# DCOM Migration Project

**Created:** 2025-10-14  
**Source Project:** DCOM  
**Target Project:** DCOM1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DCOM`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DCOM)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DCOM1)
...
```powershell
.\RunMigration.ps1 -Project DCOM -Step 01
.\RunMigration.ps1 -Project DCOM -Step 02
.\RunMigration.ps1 -Project DCOM -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DCOM -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DCOM`
