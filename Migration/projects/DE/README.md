# DE Migration Project

**Created:** 2025-10-14  
**Source Project:** DE  
**Target Project:** DE1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DE`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DE)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DE1)
...
```powershell
.\RunMigration.ps1 -Project DE -Step 01
.\RunMigration.ps1 -Project DE -Step 02
.\RunMigration.ps1 -Project DE -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DE -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DE`
