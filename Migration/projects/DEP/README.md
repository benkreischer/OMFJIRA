...
> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DEP`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DEP)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DEP1)
...
```powershell
.\RunMigration.ps1 -Project DEP -Step 01
.\RunMigration.ps1 -Project DEP -Step 02
.\RunMigration.ps1 -Project DEP -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DEP -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DEP`
