# DLP Migration Project

**Created:** 2025-10-14  
**Source Project:** DLP  
**Target Project:** DLP1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DLP`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DLP)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DLP1)
...
```powershell
.\RunMigration.ps1 -Project DLP -Step 01
.\RunMigration.ps1 -Project DLP -Step 02
.\RunMigration.ps1 -Project DLP -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DLP -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DLP`
