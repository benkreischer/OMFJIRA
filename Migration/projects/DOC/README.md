# DOC Migration Project

**Created:** 2025-10-15  
**Source Project:** DOC  
**Target Project:** DOC1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DOC`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DOC)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DOC1)
...
```powershell
.\RunMigration.ps1 -Project DOC -Step 01
.\RunMigration.ps1 -Project DOC -Step 02
.\RunMigration.ps1 -Project DOC -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DOC -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DOC`
