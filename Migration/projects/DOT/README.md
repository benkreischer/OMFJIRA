# DOT Migration Project

**Created:** 2025-10-14  
**Source Project:** DOT  
**Target Project:** DOT1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DOT`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DOT)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DOT1)
...
```powershell
.\RunMigration.ps1 -Project DOT -Step 01
.\RunMigration.ps1 -Project DOT -Step 02
.\RunMigration.ps1 -Project DOT -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DOT -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DOT`
