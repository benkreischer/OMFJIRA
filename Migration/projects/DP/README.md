# DP Migration Project

**Created:** 2025-10-14  
**Source Project:** DP  
**Target Project:** DP1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DP`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DP)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DP1)
...
```powershell
.\RunMigration.ps1 -Project DP -Step 01
.\RunMigration.ps1 -Project DP -Step 02
.\RunMigration.ps1 -Project DP -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DP -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DP`
