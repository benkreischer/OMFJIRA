# DPSS Migration Project

**Created:** 2025-10-14  
**Source Project:** DPSS  
**Target Project:** DPSS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DPSS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DPSS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DPSS1)
...
```powershell
.\RunMigration.ps1 -Project DPSS -Step 01
.\RunMigration.ps1 -Project DPSS -Step 02
.\RunMigration.ps1 -Project DPSS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DPSS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DPSS`
