# DR Migration Project

**Created:** 2025-10-14  
**Source Project:** DR  
**Target Project:** DR1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DR`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DR)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DR1)
...
```powershell
.\RunMigration.ps1 -Project DR -Step 01
.\RunMigration.ps1 -Project DR -Step 02
.\RunMigration.ps1 -Project DR -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DR -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DR`
