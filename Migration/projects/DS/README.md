...
**Created:** 2025-10-14  
**Source Project:** DS  
**Target Project:** DS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey DS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: DS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: DS1)
...
```powershell
.\RunMigration.ps1 -Project DS -Step 01
.\RunMigration.ps1 -Project DS -Step 02
.\RunMigration.ps1 -Project DS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project DS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project DS`
