# EA Migration Project

**Created:** 2025-10-14  
**Source Project:** EA  
**Target Project:** EA1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey EA`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: EA)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: EA1)
...
```powershell
.\RunMigration.ps1 -Project EA -Step 01
.\RunMigration.ps1 -Project EA -Step 02
.\RunMigration.ps1 -Project EA -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project EA -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project EA`
