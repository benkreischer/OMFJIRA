# EDME Migration Project

**Created:** 2025-10-16  
**Source Project:** EDME  
**Target Project:** EDME1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey EDME`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: EDME)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: EDME1)
...
```powershell
.\RunMigration.ps1 -Project EDME -Step 01
.\RunMigration.ps1 -Project EDME -Step 02
.\RunMigration.ps1 -Project EDME -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project EDME -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project EDME`
