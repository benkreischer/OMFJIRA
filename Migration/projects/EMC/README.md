# EMC Migration Project

**Created:** 2025-10-14  
**Source Project:** EMC  
**Target Project:** EMC1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey EMC`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: EMC)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: EMC1)
...
```powershell
.\RunMigration.ps1 -Project EMC -Step 01
.\RunMigration.ps1 -Project EMC -Step 02
.\RunMigration.ps1 -Project EMC -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project EMC -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project EMC`
