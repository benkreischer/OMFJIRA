# ENGOPS Migration Project

**Created:** 2025-10-14  
**Source Project:** ENGOPS  
**Target Project:** ENGOPS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey ENGOPS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: ENGOPS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: ENGOPS1)
...
.\RunMigration.ps1 -Project ENGOPS
```
...
```powershell
.\RunMigration.ps1 -Project ENGOPS -Step 01
.\RunMigration.ps1 -Project ENGOPS -Step 02
.\RunMigration.ps1 -Project ENGOPS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project ENGOPS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project ENGOPS`
