# EPMC Migration Project

**Created:** 2025-10-14  
**Source Project:** EPMC  
**Target Project:** EPMC1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey EPMC`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: EPMC)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: EPMC1)
...
```powershell
.\RunMigration.ps1 -Project EPMC -Step 01
.\RunMigration.ps1 -Project EPMC -Step 02
.\RunMigration.ps1 -Project EPMC -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project EPMC -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project EPMC`
