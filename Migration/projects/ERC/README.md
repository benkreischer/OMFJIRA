# ERC Migration Project

**Created:** 2025-10-14  
**Source Project:** ERC  
**Target Project:** ERC1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey ERC`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: ERC)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: ERC1)
...
```powershell
.\RunMigration.ps1 -Project ERC -Step 01
.\RunMigration.ps1 -Project ERC -Step 02
.\RunMigration.ps1 -Project ERC -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project ERC -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project ERC`
