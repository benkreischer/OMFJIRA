...
> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey ERD`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: ERD)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: ERD1)
...
```powershell
.\RunMigration.ps1 -Project ERD -Step 01
.\RunMigration.ps1 -Project ERD -Step 02
.\RunMigration.ps1 -Project ERD -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project ERD -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project ERD`
