# ESDL Migration Project

**Created:** 2025-10-14  
**Source Project:** ESDL  
**Target Project:** ESDL1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey ESDL`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: ESDL)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: ESDL1)
...
```powershell
.\RunMigration.ps1 -Project ESDL -Step 01
.\RunMigration.ps1 -Project ESDL -Step 02
.\RunMigration.ps1 -Project ESDL -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project ESDL -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project ESDL`
