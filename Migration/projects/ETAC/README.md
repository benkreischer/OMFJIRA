# ETAC Migration Project

**Created:** 2025-10-14  
**Source Project:** ETAC  
**Target Project:** ETAC1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey ETAC`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: ETAC)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: ETAC1)
...
```powershell
.\RunMigration.ps1 -Project ETAC -Step 01
.\RunMigration.ps1 -Project ETAC -Step 02
.\RunMigration.ps1 -Project ETAC -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project ETAC -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project ETAC`
