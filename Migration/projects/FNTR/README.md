...
> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey FNTR`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: FNTR)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: FNTR1)
...
```powershell
.\RunMigration.ps1 -Project FNTR -Step 01
.\RunMigration.ps1 -Project FNTR -Step 02
.\RunMigration.ps1 -Project FNTR -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project FNTR -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project FNTR`
