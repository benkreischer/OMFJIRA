# FORMS Migration Project

**Created:** 2025-10-14  
**Source Project:** FORMS  
**Target Project:** FORMS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey FORMS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: FORMS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: FORMS1)
...
.\RunMigration.ps1 -Project FORMS
```
...
```powershell
.\RunMigration.ps1 -Project FORMS -Step 01
.\RunMigration.ps1 -Project FORMS -Step 02
.\RunMigration.ps1 -Project FORMS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project FORMS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project FORMS`
