# FSYS Migration Project

**Created:** 2025-10-14  
**Source Project:** FSYS  
**Target Project:** FSYS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey FSYS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: FSYS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: FSYS1)
...
```powershell
.\RunMigration.ps1 -Project FSYS -Step 01
.\RunMigration.ps1 -Project FSYS -Step 02
.\RunMigration.ps1 -Project FSYS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project FSYS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project FSYS`
