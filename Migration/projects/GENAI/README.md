# GENAI Migration Project

**Created:** 2025-10-14  
**Source Project:** GENAI  
**Target Project:** GENAI1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey GENAI`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: GENAI)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: GENAI1)
...
.\RunMigration.ps1 -Project GENAI
```
...
```powershell
.\RunMigration.ps1 -Project GENAI -Step 01
.\RunMigration.ps1 -Project GENAI -Step 02
.\RunMigration.ps1 -Project GENAI -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project GENAI -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project GENAI`
