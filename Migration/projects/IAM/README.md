# IAM Migration Project

**Created:** 2025-10-14  
**Source Project:** IAM  
**Target Project:** IAM1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey IAM`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: IAM)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: IAM1)
...
```powershell
.\RunMigration.ps1 -Project IAM -Step 01
.\RunMigration.ps1 -Project IAM -Step 02
.\RunMigration.ps1 -Project IAM -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project IAM -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project IAM`
