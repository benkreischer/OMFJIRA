# ICS Migration Project

**Created:** 2025-10-15  
**Source Project:** ICS  
**Target Project:** ICS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey ICS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: ICS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: ICS1)
...
```powershell
.\RunMigration.ps1 -Project ICS -Step 01
.\RunMigration.ps1 -Project ICS -Step 02
.\RunMigration.ps1 -Project ICS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project ICS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project ICS`
