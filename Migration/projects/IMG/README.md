# IMG Migration Project

**Created:** 2025-10-14  
**Source Project:** IMG  
**Target Project:** IMG1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey IMG`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: IMG)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: IMG1)
...
```powershell
.\RunMigration.ps1 -Project IMG -Step 01
.\RunMigration.ps1 -Project IMG -Step 02
.\RunMigration.ps1 -Project IMG -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project IMG -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project IMG`
