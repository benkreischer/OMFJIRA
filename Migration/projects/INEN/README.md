# INEN Migration Project

**Created:** 2025-10-15  
**Source Project:** INEN  
**Target Project:** INEN1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey INEN`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: INEN)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: INEN1)
...
```powershell
.\RunMigration.ps1 -Project INEN -Step 01
.\RunMigration.ps1 -Project INEN -Step 02
.\RunMigration.ps1 -Project INEN -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project INEN -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project INEN`
