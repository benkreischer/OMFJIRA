# INI Migration Project

**Created:** 2025-10-15  
**Source Project:** INI  
**Target Project:** INI1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey INI`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: INI)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: INI1)
...
```powershell
.\RunMigration.ps1 -Project INI -Step 01
.\RunMigration.ps1 -Project INI -Step 02
.\RunMigration.ps1 -Project INI -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project INI -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project INI`
