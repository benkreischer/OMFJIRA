# INSO Migration Project

**Created:** 2025-10-16  
**Source Project:** INSO  
**Target Project:** INSO1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey INSO`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: INSO)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: INSO1)
...
```powershell
.\RunMigration.ps1 -Project INSO -Step 01
.\RunMigration.ps1 -Project INSO -Step 02
.\RunMigration.ps1 -Project INSO -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project INSO -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project INSO`
