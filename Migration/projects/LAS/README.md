...
> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey LAS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: LAS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: LAS1)
...
```powershell
.\RunMigration.ps1 -Project LAS -Step 01
.\RunMigration.ps1 -Project LAS -Step 02
.\RunMigration.ps1 -Project LAS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project LAS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project LAS`
