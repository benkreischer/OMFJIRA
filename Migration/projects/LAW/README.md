# LAW Migration Project

**Created:** 2025-10-16  
**Source Project:** LAW  
**Target Project:** LAW1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey LAW`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: LAW)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: LAW1)
...
```powershell
.\RunMigration.ps1 -Project LAW -Step 01
.\RunMigration.ps1 -Project LAW -Step 02
.\RunMigration.ps1 -Project LAW -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project LAW -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project LAW`
