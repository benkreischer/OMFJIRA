# MCARD Migration Project

**Created:** 2025-10-14  
**Source Project:** MCARD  
**Target Project:** MCARD1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey MCARD`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: MCARD)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: MCARD1)
...
.\RunMigration.ps1 -Project MCARD
```
...
```powershell
.\RunMigration.ps1 -Project MCARD -Step 01
.\RunMigration.ps1 -Project MCARD -Step 02
.\RunMigration.ps1 -Project MCARD -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project MCARD -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project MCARD`
