# MCCE Migration Project

**Created:** 2025-10-14  
**Source Project:** MCCE  
**Target Project:** MCCE1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey MCCE`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: MCCE)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: MCCE1)
...
```powershell
.\RunMigration.ps1 -Project MCCE -Step 01
.\RunMigration.ps1 -Project MCCE -Step 02
.\RunMigration.ps1 -Project MCCE -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project MCCE -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project MCCE`
