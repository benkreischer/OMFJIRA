# MCCP Migration Project

**Created:** 2025-10-14  
**Source Project:** MCCP  
**Target Project:** MCCP1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey MCCP`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: MCCP)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: MCCP1)
...
```powershell
.\RunMigration.ps1 -Project MCCP -Step 01
.\RunMigration.ps1 -Project MCCP -Step 02
.\RunMigration.ps1 -Project MCCP -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project MCCP -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project MCCP`
