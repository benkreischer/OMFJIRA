# MCLD Migration Project

**Created:** 2025-10-14  
**Source Project:** MCLD  
**Target Project:** MCLD1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey MCLD`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: MCLD)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: MCLD1)
...
```powershell
.\RunMigration.ps1 -Project MCLD -Step 01
.\RunMigration.ps1 -Project MCLD -Step 02
.\RunMigration.ps1 -Project MCLD -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project MCLD -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project MCLD`
