# MCLNE Migration Project

**Created:** 2025-10-14  
**Source Project:** MCLNE  
**Target Project:** MCLNE1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey MCLNE`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: MCLNE)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: MCLNE1)
...
.\RunMigration.ps1 -Project MCLNE
```
...
```powershell
.\RunMigration.ps1 -Project MCLNE -Step 01
.\RunMigration.ps1 -Project MCLNE -Step 02
.\RunMigration.ps1 -Project MCLNE -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project MCLNE -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project MCLNE`
