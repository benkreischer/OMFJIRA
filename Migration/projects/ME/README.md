# ME Migration Project

**Created:** 2025-10-15  
**Source Project:** ME  
**Target Project:** ME1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey ME`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: ME)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: ME1)
...
```powershell
.\RunMigration.ps1 -Project ME -Step 01
.\RunMigration.ps1 -Project ME -Step 02
.\RunMigration.ps1 -Project ME -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project ME -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project ME`
