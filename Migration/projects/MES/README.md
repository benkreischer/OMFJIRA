...
**Created:** 2025-10-15  
**Source Project:** MES  
**Target Project:** MES1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey MES`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: MES)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: MES1)
...
```powershell
.\RunMigration.ps1 -Project MES -Step 01
.\RunMigration.ps1 -Project MES -Step 02
.\RunMigration.ps1 -Project MES -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project MES -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project MES`
