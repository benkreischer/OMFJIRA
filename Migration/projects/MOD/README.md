# MOD Migration Project

**Created:** 2025-10-15  
**Source Project:** MOD  
**Target Project:** MOD1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey MOD`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: MOD)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: MOD1)
...
```powershell
.\RunMigration.ps1 -Project MOD -Step 01
.\RunMigration.ps1 -Project MOD -Step 02
.\RunMigration.ps1 -Project MOD -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project MOD -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project MOD`
