# NOW Migration Project

**Created:** 2025-10-15  
**Source Project:** NOW  
**Target Project:** NOW1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey NOW`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: NOW)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: NOW1)
...
```powershell
.\RunMigration.ps1 -Project NOW -Step 01
.\RunMigration.ps1 -Project NOW -Step 02
.\RunMigration.ps1 -Project NOW -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project NOW -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project NOW`
