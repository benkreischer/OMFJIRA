# OAE Migration Project

**Created:** 2025-10-15  
**Source Project:** OAE  
**Target Project:** OAE1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey OAE`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: OAE)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: OAE1)
...
```powershell
.\RunMigration.ps1 -Project OAE -Step 01
.\RunMigration.ps1 -Project OAE -Step 02
.\RunMigration.ps1 -Project OAE -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project OAE -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project OAE`
