# OBE Migration Project

**Created:** 2025-10-15  
**Source Project:** OBE  
**Target Project:** OBE1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey OBE`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: OBE)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: OBE1)
...
```powershell
.\RunMigration.ps1 -Project OBE -Step 01
.\RunMigration.ps1 -Project OBE -Step 02
.\RunMigration.ps1 -Project OBE -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project OBE -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project OBE`
