# OBSRV Migration Project

**Created:** 2025-10-14  
**Source Project:** OBSRV  
**Target Project:** OBSRV1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey OBSRV`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: OBSRV)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: OBSRV1)
...
.\RunMigration.ps1 -Project OBSRV
```
...
```powershell
.\RunMigration.ps1 -Project OBSRV -Step 01
.\RunMigration.ps1 -Project OBSRV -Step 02
.\RunMigration.ps1 -Project OBSRV -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project OBSRV -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project OBSRV`
