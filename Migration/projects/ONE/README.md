...
**Created:** 2025-10-15  
**Source Project:** ONE  
**Target Project:** ONE1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey ONE`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: ONE)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: ONE1)
...
```powershell
.\RunMigration.ps1 -Project ONE -Step 01
.\RunMigration.ps1 -Project ONE -Step 02
.\RunMigration.ps1 -Project ONE -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project ONE -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project ONE`
