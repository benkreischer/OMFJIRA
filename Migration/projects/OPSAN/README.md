# OPSAN Migration Project

**Created:** 2025-10-15  
**Source Project:** OPSAN  
**Target Project:** OPSAN1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey OPSAN`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: OPSAN)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: OPSAN1)
...
.\RunMigration.ps1 -Project OPSAN
```
...
```powershell
.\RunMigration.ps1 -Project OPSAN -Step 01
.\RunMigration.ps1 -Project OPSAN -Step 02
.\RunMigration.ps1 -Project OPSAN -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project OPSAN -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project OPSAN`
