# ORL Migration Project

**Created:** 2025-10-14  
**Source Project:** ORL  
**Target Project:** ORL1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey ORL`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: ORL)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: ORL1)
...
```powershell
.\RunMigration.ps1 -Project ORL -Step 01
.\RunMigration.ps1 -Project ORL -Step 02
.\RunMigration.ps1 -Project ORL -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project ORL -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project ORL`
