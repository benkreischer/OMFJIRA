# OSO Migration Project

**Created:** 2025-10-15  
**Source Project:** OSO  
**Target Project:** OSO1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey OSO`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: OSO)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: OSO1)
...
```powershell
.\RunMigration.ps1 -Project OSO -Step 01
.\RunMigration.ps1 -Project OSO -Step 02
.\RunMigration.ps1 -Project OSO -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project OSO -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project OSO`
