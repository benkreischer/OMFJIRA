# PAY Migration Project

**Created:** 2025-10-14  
**Source Project:** PAY  
**Target Project:** PAY1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey PAY`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: PAY)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: PAY1)
...
```powershell
.\RunMigration.ps1 -Project PAY -Step 01
.\RunMigration.ps1 -Project PAY -Step 02
.\RunMigration.ps1 -Project PAY -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project PAY -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project PAY`
