# PDS Migration Project

**Created:** 2025-10-15  
**Source Project:** PDS  
**Target Project:** PDS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey PDS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: PDS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: PDS1)
...
```powershell
.\RunMigration.ps1 -Project PDS -Step 01
.\RunMigration.ps1 -Project PDS -Step 02
.\RunMigration.ps1 -Project PDS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project PDS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project PDS`
