# PLAQ Migration Project

**Created:** 2025-10-16  
**Source Project:** PLAQ  
**Target Project:** PLAQ1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey PLAQ`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: PLAQ)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: PLAQ1)
...
```powershell
.\RunMigration.ps1 -Project PLAQ -Step 01
.\RunMigration.ps1 -Project PLAQ -Step 02
.\RunMigration.ps1 -Project PLAQ -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project PLAQ -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project PLAQ`
