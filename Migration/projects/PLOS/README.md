# PLOS Migration Project

**Created:** 2025-10-16  
**Source Project:** PLOS  
**Target Project:** PLOS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey PLOS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: PLOS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: PLOS1)
...
```powershell
.\RunMigration.ps1 -Project PLOS -Step 01
.\RunMigration.ps1 -Project PLOS -Step 02
.\RunMigration.ps1 -Project PLOS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project PLOS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project PLOS`
