# POP Migration Project

**Created:** 2025-10-16  
**Source Project:** POP  
**Target Project:** POP1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey POP`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: POP)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: POP1)
...
```powershell
.\RunMigration.ps1 -Project POP -Step 01
.\RunMigration.ps1 -Project POP -Step 02
.\RunMigration.ps1 -Project POP -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project POP -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project POP`
