# POS Migration Project

**Created:** 2025-10-16  
**Source Project:** POS  
**Target Project:** POS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey POS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: POS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: POS1)
...
```powershell
.\RunMigration.ps1 -Project POS -Step 01
.\RunMigration.ps1 -Project POS -Step 02
.\RunMigration.ps1 -Project POS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project POS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project POS`
