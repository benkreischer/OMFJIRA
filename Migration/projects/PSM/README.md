# PSM Migration Project

**Created:** 2025-10-15  
**Source Project:** PSM  
**Target Project:** PSM1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey PSM`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: PSM)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: PSM1)
...
```powershell
.\RunMigration.ps1 -Project PSM -Step 01
.\RunMigration.ps1 -Project PSM -Step 02
.\RunMigration.ps1 -Project PSM -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project PSM -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project PSM`
