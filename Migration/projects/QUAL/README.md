# QUAL Migration Project

**Created:** 2025-10-13  
**Source Project:** QUAL  
**Target Project:** QUAL1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey QUAL`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: QUAL)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: QUAL1)
...
```powershell
.\RunMigration.ps1 -Project QUAL -Step 01
.\RunMigration.ps1 -Project QUAL -Step 02
.\RunMigration.ps1 -Project QUAL -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project QUAL -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project QUAL`
