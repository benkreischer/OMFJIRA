...
> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey REM`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: REM)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: REM1)
...
```powershell
.\RunMigration.ps1 -Project REM -Step 01
.\RunMigration.ps1 -Project REM -Step 02
.\RunMigration.ps1 -Project REM -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project REM -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project REM`
