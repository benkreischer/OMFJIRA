# SCOF Migration Project

**Created:** 2025-10-16  
**Source Project:** SCOF  
**Target Project:** SCOF1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey SCOF`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: SCOF)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: SCOF1)
...
```powershell
.\RunMigration.ps1 -Project SCOF -Step 01
.\RunMigration.ps1 -Project SCOF -Step 02
.\RunMigration.ps1 -Project SCOF -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project SCOF -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project SCOF`
