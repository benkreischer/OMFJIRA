# SCON Migration Project

**Created:** 2025-10-16  
**Source Project:** SCON  
**Target Project:** SCON1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey SCON`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: SCON)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: SCON1)
...
```powershell
.\RunMigration.ps1 -Project SCON -Step 01
.\RunMigration.ps1 -Project SCON -Step 02
.\RunMigration.ps1 -Project SCON -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project SCON -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project SCON`
