# SE Migration Project

**Created:** 2025-10-16  
**Source Project:** SE  
**Target Project:** SE1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey SE`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: SE)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: SE1)
...
```powershell
.\RunMigration.ps1 -Project SE -Step 01
.\RunMigration.ps1 -Project SE -Step 02
.\RunMigration.ps1 -Project SE -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project SE -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project SE`
