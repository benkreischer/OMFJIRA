# SHP Migration Project

**Created:** 2025-10-15  
**Source Project:** SHP  
**Target Project:** SHP1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey SHP`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: SHP)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: SHP1)
...
```powershell
.\RunMigration.ps1 -Project SHP -Step 01
.\RunMigration.ps1 -Project SHP -Step 02
.\RunMigration.ps1 -Project SHP -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project SHP -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project SHP`
