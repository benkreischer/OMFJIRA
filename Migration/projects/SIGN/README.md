# SIGN Migration Project

**Created:** 2025-10-16  
**Source Project:** SIGN  
**Target Project:** SIGN1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey SIGN`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: SIGN)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: SIGN1)
...
```powershell
.\RunMigration.ps1 -Project SIGN -Step 01
.\RunMigration.ps1 -Project SIGN -Step 02
.\RunMigration.ps1 -Project SIGN -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project SIGN -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project SIGN`
