# SRE Migration Project

**Created:** 2025-10-16  
**Source Project:** SRE  
**Target Project:** SRE1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey SRE`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: SRE)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: SRE1)
...
```powershell
.\RunMigration.ps1 -Project SRE -Step 01
.\RunMigration.ps1 -Project SRE -Step 02
.\RunMigration.ps1 -Project SRE -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project SRE -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project SRE`
