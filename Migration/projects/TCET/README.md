# TCET Migration Project

**Created:** 2025-10-15  
**Source Project:** TCET  
**Target Project:** TCET1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey TCET`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: TCET)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: TCET1)
...
```powershell
.\RunMigration.ps1 -Project TCET -Step 01
.\RunMigration.ps1 -Project TCET -Step 02
.\RunMigration.ps1 -Project TCET -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project TCET -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project TCET`
