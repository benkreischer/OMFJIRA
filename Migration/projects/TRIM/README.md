# TRIM Migration Project

**Created:** 2025-10-15  
**Source Project:** TRIM  
**Target Project:** TRIM1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey TRIM`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: TRIM)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: TRIM1)
...
```powershell
.\RunMigration.ps1 -Project TRIM -Step 01
.\RunMigration.ps1 -Project TRIM -Step 02
.\RunMigration.ps1 -Project TRIM -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project TRIM -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project TRIM`
