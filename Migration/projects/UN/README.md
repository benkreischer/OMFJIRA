# UN Migration Project

**Created:** 2025-10-15  
**Source Project:** UN  
**Target Project:** UN1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey UN`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: UN)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: UN1)
...
```powershell
.\RunMigration.ps1 -Project UN -Step 01
.\RunMigration.ps1 -Project UN -Step 02
.\RunMigration.ps1 -Project UN -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project UN -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project UN`
