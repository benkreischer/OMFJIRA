# UPT Migration Project

**Created:** 2025-10-15  
**Source Project:** UPT  
**Target Project:** UPT1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey UPT`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: UPT)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: UPT1)
...
```powershell
.\RunMigration.ps1 -Project UPT -Step 01
.\RunMigration.ps1 -Project UPT -Step 02
.\RunMigration.ps1 -Project UPT -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project UPT -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project UPT`
