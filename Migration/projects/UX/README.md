# UX Migration Project

**Created:** 2025-10-15  
**Source Project:** UX  
**Target Project:** UX1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey UX`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: UX)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: UX1)
...
```powershell
.\RunMigration.ps1 -Project UX -Step 01
.\RunMigration.ps1 -Project UX -Step 02
.\RunMigration.ps1 -Project UX -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project UX -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project UX`
