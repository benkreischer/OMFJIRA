...
> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey WL`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: WL)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: WL1)
...
```powershell
.\RunMigration.ps1 -Project WL -Step 01
.\RunMigration.ps1 -Project WL -Step 02
.\RunMigration.ps1 -Project WL -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project WL -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project WL`
