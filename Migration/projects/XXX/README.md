...
**Source Project:** {PROJECT_KEY}  
**Target Project:** {PROJECT_KEY}1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey {PROJECT_KEY}`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: {PROJECT_KEY})
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: {PROJECT_KEY}1)
...
**All steps must be run using `.\RunMigration.ps1 -Project {PROJECT_KEY} -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project {PROJECT_KEY}`
