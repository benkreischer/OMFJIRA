# ZCS Migration Project

**Created:** 2025-10-16  
**Source Project:** ZCS  
**Target Project:** ZCS1 (Sandbox)

---

## 🎯 Quick Start - 3 Simple Steps

> **Note:** This project was created using `.\CreateNewProject.ps1 -ProjectKey ZCS`
...
- **SourceEnvironment.ProjectKey** - Source project key (currently: ZCS)
- **TargetEnvironment.BaseUrl** - Your target Jira URL
- **TargetEnvironment.ProjectKey** - Target project key (currently: ZCS1)
...
```powershell
.\RunMigration.ps1 -Project ZCS -Step 01
.\RunMigration.ps1 -Project ZCS -Step 02
.\RunMigration.ps1 -Project ZCS -Step 03
# ... continue through step 18
```
...
**All steps must be run using `.\RunMigration.ps1 -Project ZCS -Step ##`**
...
2. **Start** - Run `.\RunMigration.ps1 -Project ZCS`
